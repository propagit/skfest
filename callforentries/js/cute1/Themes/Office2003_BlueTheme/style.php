...
<?php   echo $editorid; ?> .CuteEditorButtonActive { margin:0; vertical-align:middle; border:#0a246a 1px solid!important; background-color:#FFDBA3;background-image: url(Images/toolbarbutton.over.gif&theme=Custom)}

<?php   echo $editorid; ?> .CuteEditorButtonOver { margin:0;vertical-align:middle;border:#0a246a 1px solid!important; background-color:#FFDBA3;background-image: url(Images/toolbarbutton.over.gif&theme=Custom);}
