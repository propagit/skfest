...
<?php   echo $editorid; ?> {background-color:#D6D3CE!important; border: #999999 1px solid!important;}
...
<?php   echo $editorid; ?> .CuteEditorDropDown { float: left; border: #dddddd 1px solid;margin:2px 1px 2px 1px;padding:2px;}
...
<?php   echo $editorid; ?> .CuteEditorFrameContainer {padding:0;margin:2px 0 0 0;width:100%;height:100%;}
...
<?php   echo $editorid; ?> .CuteEditorFrame {width:100%;height:100%;padding:0;border-top: #aaaaaa 1px solid!important;border-bottom: #999999 1px solid!important;border-left: #ffffff 0 solid!important;border-right: #ffffff 0 solid!important;}

<?php   echo $editorid; ?> .CuteEditorButton { margin:1px; vertical-align:middle;}

<?php   echo $editorid; ?> .CuteEditorButtonActive { margin:0; vertical-align:middle; border-right: buttonshadow 1px solid; border-top: buttonhighlight 1px solid; border-left: buttonhighlight 1px solid; border-bottom: buttonshadow 1px solid;}

<?php   echo $editorid; ?> .CuteEditorButtonOver { border-right: buttonshadow 1px solid; border-top: buttonhighlight 1px solid; border-left: buttonhighlight 1px solid; border-bottom: buttonshadow 1px solid; PADDING: 0; MARGIN: 0; vertical-align: middle;}
