...

			{
...

				{
...

					{
						...
						document.write("<td style='align: left; height: 20; font-size: 12px; ' bgcolor=white width='18' onClick='getchar(this)' onmouseover='spcOver(this)' onmouseout='spcOut(this)'>");
		...
		<div id="container">
			...
			<br>
							...
							<table id="charstable1" width="95%"  cellspacing="1" cellpadding="1" border="0"
								...
								style="FONT-FAMILY: Verdana;display:none;height:222; background-color:#696969; border-color: #696969">
