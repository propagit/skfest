...
error_reporting(E_ALL ^ E_NOTICE);
	...
	if (strpos(strtolower($current_Path),strtolower(trim($TemplateGalleryPath))) <0 || $TemplateGalleryPath=="")
    ...
    if($dirlist)
        ...
        //add the html for the folders
		    ...
		    $str_openfolderEvent="onclick=\"parent.SetUpload_FolderPath('".$current_Path.$folpath.$file."');location.href='browse_Template.php?".$setting."&loc=".$folpath.$file."&MP=".$current_Path."';\"";
...
<html>
  ...
  <head>
    ...
    <script type="text/javascript">
      ...
      var folderpath = "browse_Template.php?<?php echo $setting ; ?>&MP=<?php echo $current_Path ; ?>";
      ...
      for (i=0;i<arrloc.length-2;i++) {
			...
			str="browse_Template.php?<?php echo $setting ; ?>&MP=<?php echo $current_Path ; ?>&loc=" + str + "&u=y";
