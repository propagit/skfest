...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title><?php echo GetString("Preview") ; ?>
				...
				<tbody>
					...
					<tr>
						...
						<td style="HEIGHT: 100%" colspan="3">
							...
							<iframe id="idSource" src="../template.php" scrolling="auto" style="WIDTH: 100%; HEIGHT: 100%;background-color:#ffffff;">
					...
					<tr>
						...
						<td>
							...
							<img src="../Images/print.gif" onclick="window.print();" title="<?php echo GetString("Print") ; ?>" onmouseover="CuteEditor_ColorPicker_ButtonOver(this);" />
						...
						<td class="dialogFooter" valign="top" align="right" style="PADDING-RIGHT: 13px; PADDING-LEFT: 13px; PADDING-BOTTOM: 7px; PADDING-TOP: 7px">
							...
							<?php echo GetString("Size") ; ?>: <input type='radio' name="radio_size" id="W640" onclick='ResizeThis(640,480)' />640x480
