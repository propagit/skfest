...
<table width="85%" align=center cellpadding="1" cellspacing="2" id="tag-list">
	...
	<td nowrap colspan="5" style="padding-top:5">
		...
		<span style="width:90"><?php echo GetString("StartingNumber") ; ?></span>: <input onkeypress="return CancelEventIfNotDigit()" id="inp_start" type="text" name="inp_start" value="1" size="3">
	...
	<td colspan="5">		
		...
		<input type="checkbox" id="inp_checked" onclick="ToggleCustomBullet();" /><?php echo GetString("CustomBullet") ; ?>

		<br />

		<div id="CustomBullet">

			<?php echo GetString("Image") ; ?>:

			<input type="text" id="inp_src" style="width:200px" />&nbsp;&nbsp;

			<button id="btnbrowse">...</button>
...
<script type="text/javascript" src="../Scripts/Dialog/Dialog_Tag_Li.js"></script>