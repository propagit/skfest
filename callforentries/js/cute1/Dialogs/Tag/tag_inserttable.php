...
<table width="400" cellpadding="1" cellspacing="0" onmouseover="CuteEditor_ColorPicker_ButtonOver(this);"
	...
	<tr>
		...
		<td style="padding-left:20px; background-color:white">
			...
			<img src="../Images/h-f-3Columns-Body.gif" alt="<?php echo GetString("Table layout") ; ?>" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 

			<?php echo GetString("Table layout") ; ?>
...
<div id="list_Templates" style="display:none;">
	...
	<div style="position:absolute; top:0; left:0; overflow:scroll; overflow-x:hidden;width:400; height:220; border-bottom:0px solid black;">
		...
		<div onmouseover="this.style.filter='progid:DXImageTransform.Microsoft.Gradient(GradientType=0, StartColorStr=#99ccff, EndColorStr=#FFFFFF)';"
			...
			<span onclick="parent.selectTemplate(1)"><img src="../Images/One-Column-Table.gif" alt="<?php echo GetString("1ColumnTable") ; ?>" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 

				<?php echo GetString("1ColumnTable") ; ?></span>
		...
		<div onmouseover="this.style.filter='progid:DXImageTransform.Microsoft.Gradient(GradientType=0, StartColorStr=yellowgreen, EndColorStr=#FFFFFF)';"
			...
			<span onclick="parent.selectTemplate(2)"><img src="../Images/Two-Column-Table.gif" alt="<?php echo GetString("2ColumnTable") ; ?>" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 

				<?php echo GetString("2ColumnTable") ; ?></span>
		...
		<div onmouseover="this.style.filter='progid:DXImageTransform.Microsoft.Gradient(GradientType=0, StartColorStr=gold, EndColorStr=#FFFFFF)';"
			...
			<span onclick="parent.selectTemplate(3)"><img src="../Images/Three-Column-Table.gif" alt="<?php echo GetString("3ColumnTable") ; ?>"

					/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php echo GetString("3ColumnTable") ; ?></span>
		...
		<div onmouseover="this.style.filter='progid:DXImageTransform.Microsoft.Gradient(GradientType=0, StartColorStr=violet, EndColorStr=#FFFFFF)';"
			...
			<span onclick="parent.selectTemplate(4)"><img src="../Images/h-R-t-Body.gif" alt="<?php echo GetString("Header-Right-TopLeft-Body") ; ?>"

					/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php echo GetString("Header-Right-TopLeft-Body") ; ?></span>
		...
		<div onmouseover="this.style.filter='progid:DXImageTransform.Microsoft.Gradient(GradientType=0, StartColorStr=#99ccff, EndColorStr=#FFFFFF)';"
			...
			<span onclick="parent.selectTemplate(5)"><img src="../Images/h-l-tr-Body.gif" alt="<?php echo GetString("Header-Left-TopRight-Body") ; ?>"

					/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php echo GetString("Header-Left-TopRight-Body") ; ?></span>
		...
		<div onmouseover="this.style.filter='progid:DXImageTransform.Microsoft.Gradient(GradientType=0, StartColorStr=#99ccff, EndColorStr=#FFFFFF)';"
			...
			<span onclick="parent.selectTemplate(6)"><img src="../Images/h-f-3Columns-Body.gif" alt="<?php echo GetString("Header-Footer-3-Columns") ; ?>"

					/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php echo GetString("Header-Footer-3-Columns") ; ?></span>
	...
	<table border="0" cellspacing="0" cellpadding="2"  class="normal" width="99%">
		...
		<tr>
			...
			<td align="center">
				...
				<?php echo GetString("EditCell") ; ?>

			</td>

			<td align="center">

				<?php echo GetString("Columns") ; ?>: <button id="subcolumns" class="addsub">-</button> <button id="addcolumns" class="addsub">
				...
				<table class="normal">
					...
					<tr>
						...
						<td colspan="2" align="center">
							...
							<input type="button" id="btn_row_dialog" value="<?php echo GetString("EditRow") ; ?>" /></td>
					...
					<tr>
						...
						<td colspan="2" align="center">
							...
							<input type="button" id="btn_cell_dialog" value="<?php echo GetString("EditCell") ; ?>" /></td>
					...
					<tr>
						...
						<td colspan="2" align="center">
							...
							<input type="button" id="btn_cell_editcell" value="<?php echo GetString("EditHtml") ; ?>" /></td>
