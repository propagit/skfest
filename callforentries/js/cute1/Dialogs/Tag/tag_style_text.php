	...
	<table border="0" cellpadding="2" cellspacing="0" class="normal">
		...
		<tr>
			...
			<td><select style="width:64" id="sel_letter">
				...
				<?php echo GetString("OR") ; ?> <input type="text" id="tb_letter" style="width:42" />
		...
		<tr>
			...
			<td><select style="width:64" id="sel_line">
				...
				<?php echo GetString("OR") ; ?> <input type="text" id="tb_line" style="width:42" />
...
<fieldset><legend><?php echo GetString("TextFlow") ; ?></legend>
	...
	<table border="0" cellspacing="0" cellpadding="2" class="normal">
		...
		<tr>
			...
			<td style="width:80"><?php echo GetString("Indentation") ; ?>:
