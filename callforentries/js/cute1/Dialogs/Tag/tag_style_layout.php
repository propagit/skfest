...
<fieldset><legend><?php echo GetString("Layout") ; ?></legend>
	...
	<table border="0" cellspacing="0" cellpadding="2" class="normal">
		...
		<tr>
			...
			<td style="width:50"><?php echo GetString("Position") ; ?>:
			...
			<td style="width:50"><?php echo GetString("Display") ; ?>:
		...
		<tr>
			...
			<td style="width:50"><?php echo GetString("Float") ; ?>:
			...
			<td style="width:50"><?php echo GetString("Clear") ; ?>:
...
<fieldset><legend><?php echo GetString("Size") ; ?></legend>
	...
	<table border="0" cellspacing="0" cellpadding="2" class="normal">
		...
		<tr>
			...
			<td style="width:50"><?php echo GetString("Top") ; ?></td>
			...
			<td style="width:50"><?php echo GetString("Height") ; ?></td>
		...
		<tr>
			...
			<td style="width:50"><?php echo GetString("Left") ; ?></td>
			...
			<td style="width:50"><?php echo GetString("Width") ; ?></td>
...
<fieldset><legend><?php echo GetString("Clipping") ; ?></legend>
	...
	<table border="0" cellspacing="0" cellpadding="2" class="normal">
		...
		<tr>
			...
			<td style="width:50"><?php echo GetString("Bottom") ; ?></td>
		...
		<tr>
			...
			<td style="width:50"><?php echo GetString("Right") ; ?></td>
...
<div id="outer" style="height:100px"><div id="div_demo"><?php echo GetString("DemoText") ; ?></div>
