	...
	<div style="padding-left: 32px;">
		...
		<table border="0" cellpadding="2" cellspacing="0" class="normal">
			...
			<tr>
				...
				<td style="width:80"><?php echo GetString("Tiling") ; ?>: </td>
		...
		<table border="0" cellpadding="2" cellspacing="0" class="normal">
			...
			<tr>
				...
				<td><select style="width:64" id="sel_hor">
					...
					<?php echo GetString("OR") ; ?> <input type="text" id="tb_hor" style="width:42" />
			...
			<tr>
				...
				<td><select style="width:64" id="sel_ver">
					...
					<?php echo GetString("OR") ; ?> <input type="text" id="tb_ver" style="width:42" />
