<fieldset>
        ...
        <legend><?php echo GetString("EditCell") ; ?></legend>
				...
				<table class="normal" cellpadding="2" cellspacing="1" width="98%">
					...
					<tr>
						...
						<td width="100"><?php echo GetString("BorderColorLight") ; ?>:</td>
					...
					<tr>
						...
						<td><?php echo GetString("noWrap") ; ?>:</td>

						<td>

							 <select id="sel_noWrap" style="width:90px">

								<option value=""><?php echo GetString("Default") ; ?></option>

								<option value="noWrap"><?php echo GetString("noWrap") ; ?></option>
						...
						<td><?php echo GetString("CellScope") ; ?>:</td>
