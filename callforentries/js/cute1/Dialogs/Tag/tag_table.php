	...
	<table class="normal" id="CaptionTable">
		...
		<tr>
			...
			<td>
			     ...
			     <input id="btn_editcaption" type="button" value="<?php echo GetString("Insert") ; ?>" />

			     <input id="btn_delcaption" type="button" value="<?php echo GetString("Delete") ; ?>" />
			...
			<td>
			    ...
			    <input id="btn_insthead" type="button" value="<?php echo GetString("Insert") ; ?>" />	
			...
			<td>
			    ...
			    <input id="btn_instfoot" type="button" value="<?php echo GetString("Insert") ; ?>" />			
