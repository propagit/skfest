							...
							<table id="tblBorderStyle" cellpadding="5" cellspacing="0" width="100%" style="table-layout:fixed;background:white">
								...
								<tr>
									...
									<td valign="top" onmouseover="CuteEditor_ColorPicker_ButtonOver(this);" onclick="doBorderStyle('')"
										...
										<div style="border:none;height:10;width:100%"><?php echo GetString("NotSet") ; ?></div>
								...
								<tr>
									...
									<td valign="top" onmouseover="CuteEditor_ColorPicker_ButtonOver(this);" onclick="doBorderStyle('double')"
										...
										<div style="border-bottom:black double;height:10;width:100%" title="double"></div>
							...
							<table cellpadding="5" cellspacing="0" width="100%" style='table-layout:fixed;background:white'>
								...
								<tr>
									...
									<td valign="top" onmouseover="CuteEditor_ColorPicker_ButtonOver(this);" onclick="doPart('left')"
										...
										<img src='../Images/border_left.gif' alt='<?php echo GetString("Left") ; ?>' />
								...
								<tr>
									...
									<td valign="top" onmouseover="CuteEditor_ColorPicker_ButtonOver(this);" onclick="doPart('top')"
										...
										<img src='../Images/border_top.gif' alt='<?php echo GetString("Top") ; ?>' />
								...
								<tr>
									...
									<td valign="top" onmouseover="CuteEditor_ColorPicker_ButtonOver(this);" onclick="doPart('right')"
										...
										<img src='../Images/border_right.gif' alt='<?php echo GetString("Right") ; ?>' />
								...
								<tr>
									...
									<td valign="top" onmouseover="CuteEditor_ColorPicker_ButtonOver(this);" onclick="doPart('bottom')"
										...
										<img src='../Images/border_bottom.gif' alt='<?php echo GetString("Bottom") ; ?>' />
					...
					<td valign="top" style="white-space:nowrap;padding:0 5px 3px 8px;" >
						...
						<table cellpadding="0" cellspacing="0" style="padding-bottom:10">
							...
							<tr>
								...
								<td><?php echo GetString("BorderColor") ; ?>:<br />

									<input autocomplete="off" type="text" id="bordercolor" name="bordercolor" size="7" style="WIDTH:57px" />

									<img alt="" id="bordercolor_Preview" src="../Images/colorpicker.gif" style="vertical-align:top"/>
							...
							<tr>
								...
								<td><?php echo GetString("ForeColor") ; ?>:<br />
							...
							<tr>
								...
								<td><?php echo GetString("Shade") ; ?>:<br />

									<input autocomplete="off" type="text" id="inp_shade" name="inp_shade" size="7" style="WIDTH:57px" > 

								    <img alt="" id="inp_shade_Preview" src="../Images/colorpicker.gif" style="vertical-align:top"/>
					...
					<td>
						...
						<table cellpadding="2" cellspacing="0">
							...
							<tr>
								...
								<td colspan="7"><?php echo GetString("Margin") ; ?>:</td>

							</tr>

							<tr>

								<td><span><?php echo GetString("Left") ; ?></span>:</td>
								...
								<td align="right"><span><?php echo GetString("Right") ; ?></span>:</td>
							...
							<tr>
								...
								<td><span><?php echo GetString("Top") ; ?></span>:</td>
								...
								<td align="right"><span><?php echo GetString("Bottom") ; ?></span>:</td>
					...
					<td style="padding-bottom:5">
						...
						<table cellpadding="2" cellspacing="0">
							...
							<tr>
								...
								<td colspan="7"><?php echo GetString("Padding") ; ?>:</td>
						...
						<fieldset><legend><?php echo GetString("Common") ; ?></legend>
							...
							<table class="normal">
								...
								<tr>
									...
									<td width="80" style="white-space:nowrap" ><?php echo GetString("Width") ; ?>:</td>
...
<script type="text/javascript" src="../Scripts/Dialog/Dialog_Tag_Div.js"></script>