...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title><?php echo GetString("InsertChars") ; ?> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
...

			{
...

				{
...

					{
						...
						document.write("<td style='height: 20; font-size: 12px; ' bgcolor=white width='18' onClick='getchar(this)' onmouseover='spcOver(this)' onmouseout='spcOut(this)' title='" + i + "' >");
			...
			<table border="0" cellspacing="2" cellpadding="2" width="99%" id="Table1">
					...
					<td align="center">
						...
						<fieldset>
							...
							<legend>
								...
								<?php echo GetString("InsertChars") ; ?>
							...
							<table id="charstable2" width="95%" cellspacing="1" cellpadding="1" border="0"
...

								{
...

									{
										...
										document.write("<td style='height: 20; font-size: 12px; ' bgcolor=white width='18' onClick='getchar(this)' onmouseover='spcOver(this)' onmouseout='spcOut(this)' title='" + n+" - "+n.replace("&","&amp;") + "' >");
				...
				<tr>
					...
					<td align="right">
					    ...
					    <input type="button" value="<?php echo GetString("Cancel") ; ?>" onclick="cancel()" />
