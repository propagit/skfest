...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head runat="server">
		...
		<title><?php echo GetString("CustomColor") ; ?></title>

		<link href="../Style/ColorPicker_NS.css" type="text/css" rel="stylesheet" />

	    <script type="text/javascript" src="../Scripts/Dialog/Dialog_ColorPicker_NS.js"></script>
			...
			<div class="tab-pane-control tab-pane" id="tabPane1">
				...
				<div class="tab-row">
					...
					<h2 class="tab">
						...
						<a tabindex="-1" href='colorpicker.php?<?php echo $_SERVER["QUERY_STRING"]; ?>'>
					...
					<h2 class="tab">
						...
						<a tabindex="-1" href='colorpicker_basic.php?<?php echo $_SERVER["QUERY_STRING"]; ?>'>
					...
					<h2 class="tab selected">
						...
						<a tabindex="-1" href='colorpicker_more.php?<?php echo $_SERVER["QUERY_STRING"]; ?>'>
...
-->
						...
						<DIV id="lblSelectColorMessage"><?php echo GetString("SelectColor") ; ?>:</DIV>

						<div id="lblRecent"><?php echo GetString("Recent") ; ?>:</div>
...
<input type="button" id="buttonok" value="<?php echo GetString("OK") ; ?>" class="formbutton" onclick="do_insert();" /> 

&nbsp;&nbsp;&nbsp;&nbsp; 

<input type="button" id="buttoncancel" value="<?php echo GetString("Cancel") ; ?>" class="formbutton" onclick="do_Close();" />
