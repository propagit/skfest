...
<iframe src="upload.php?<?php echo $setting ; ?>&Theme=<?php echo $Theme; ?>&FP=<?php echo $Current_FilesGalleryPath; ?>&Type=document" id="upload_image" frameborder="0" scrolling="auto" style="width:100%;"></iframe>
...
<input class="formbutton" type="button" value="<?php echo GetString("Cancel") ; ?>" onclick="do_Close()" id="Button2" />
			...
			<script type="text/javascript">	
	            ...
	            function UploadSaved(sFileName,path){
		            ...
		            browse_Frame.location="browse_Document.php?<?php echo $setting ; ?>&Theme=<?php echo $Theme; ?>&DP="+path+"";	
	            ...
	            {	if(path.substring(path.length-1, path.length)=='/')
		            ...
		            upload_image.src="upload.php?<?php echo $setting ; ?>&Theme=<?php echo $Theme; ?>&FP="+path+"&Type=document";
