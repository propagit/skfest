...
error_reporting(E_ALL ^ E_NOTICE);
	...
	if (strpos(strtolower($current_Path),strtolower(trim($FlashGalleryPath))) <0 || $FlashGalleryPath=="")
    ...
    if($dirlist)
        ...
        //add the html for the folders
		    ...
		    $str_openfolderEvent="onclick=\"parent.SetUpload_FolderPath('".$current_Path.$folpath.$file."');location.href='browse_Flash.php?".$setting."&loc=".$folpath.$file."&FP=".$current_Path."';\"";
...
<html>
  ...
  <head>
    ...
    <script type="text/javascript">
      ...
      var folderpath = "browse_Flash.php?<?php echo $setting ; ?>&FP=<?php echo $current_Path ; ?>";
      ...
      for (i=0;i<arrloc.length-2;i++) {
			...
			str="browse_Flash.php?<?php echo $setting ; ?>&FP=<?php echo $current_Path ; ?>&loc=" + str + "&u=y";
