...
//		document.getElementById("browse_Img_gallery").src = "browse_Img_gallery.php?GP="+path;

		this.location="browse_Img_gallery.php?<?php echo $setting; ?>&Theme=<?php echo $Theme; ?>&GP="+path;
...
<body>
  ...
  <iframe src="upload.php?<?php echo $setting ; ?>&Theme=<?php echo $Theme; ?>&FP=<?php echo $current_Path . $folpath; ?>&Type=Image" id="upload_image" frameborder="0" scrolling="auto" style="width:100%;<?php echo $Style_Display_None ; ?>"></iframe>
...
<script type="text/javascript">
...

	        {
				...
				if(document.getElementById("upload_image")!=null)
					...
					document.getElementById("upload_image").src="upload.php?<?php echo $setting ; ?>&FP="+path+"&Type=Image"
