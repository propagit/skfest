...
//********************************************************
...

  {
    ...
    $s="<link href='".$this->FilesPath."/Themes/".$this->ThemeType."/".$s.".php?EditorID=".$this->ClientID()."' type='text/css' rel='stylesheet'/>";
...

  {
...

    {
      ...
      $s=$s." <!-- CuteEditor Version 6.0 ".$this->ID." Begin --> "."\r\n";
...
//--------------------------------------	
...

  {
    ...
    { 
      ...
      $this->d["insertpagebreak"]="20";

      $this->d["insertdate"]="21";

      $this->d["timer"]="22";

      $this->d["specialchar"]="23";
      ...
      $this->d["left_to_right"]="48";

      $this->d["right_to_left"]="49";
      ...
      $this->d["passwordfield"]="54";

      $this->d["hiddenfield"]="55";

      $this->d["listbox"]="56";

      $this->d["dropdownbox"]="57";

      $this->d["optionbutton"]="58";

      $this->d["checkbox"]="59";

      $this->d["imagebutton"]="60";

      $this->d["submit"]="61";

      $this->d["reset"]="62";

      $this->d["pushbutton"]="63";
	...
	{	  
...

	  {
...

		{
		  ...
		  $t="onmousedown=\"CuteEditor_GetEditor(this).ExecCommand('ForeColor',false, ".$c.".style.backgroundColor)\"";
...

	  {
...

		{
		  ...
		  $t="onclick='return false;' disableVisual='1' oncolorchange=\"CuteEditor_GetEditor(this).ExecCommand('ForeColor',false,this.selectedColor); ".$c.".style.backgroundColor = this.selectedColor\" style=\"Behavior:url('".$this->FilesPath."/Scripts/ColorPicker.php?UC=".$this->CustomCulture."&F=".rawurlencode($this->FilesPath."/dialogs/")."');\"";
...

		{
		  ...
		  $t="onclick=\"CuteEditor_GetEditor(this).ExecCommand('SetForeColor',false,".$c.");\"";
	...
	{ 
...

	  {
...

		{
		  ...
		  $t="onmousedown=\"CuteEditor_GetEditor(this).ExecCommand('BackColor',false, ".$c.".style.backgroundColor)\"";
...

		{
		  ...
		  $t="onclick=\"CuteEditor_GetEditor(this).ExecCommand('BackColor',false, ".$c.".style.backgroundColor)\"";
...

	  {
...

		{
		  ...
		  $t="onclick='return false;' disableVisual='1' oncolorchange=\"CuteEditor_GetEditor(this).ExecCommand('BackColor',false,this.selectedColor); ".$c.".style.backgroundColor = this.selectedColor\" style=\"Behavior:url('".$this->FilesPath."/Scripts/ColorPicker.php?UC=".$this->CustomCulture."&F=".rawurlencode($this->FilesPath."/dialogs/")."');\"";
...

		{
		  ...
		  $t="onclick=\"CuteEditor_GetEditor(this).ExecCommand('SetBackColor',false,".$c.");\"";
