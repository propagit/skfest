...
<script>
	function validate()
	{
		...
		if(jQuery('#mfv_registration3').val() == '')
		{
			valid = false;
			jQuery('#mfv_registration3').css('border-color','red');
		}
	...
	function clear_contact()
	{
		...
		jQuery('#cp2').val('');
		jQuery('#cp3').val('');
		jQuery('#contact_title').val('');
		jQuery('#contact_on').val('');
		jQuery('#contact_hf').val('');
		jQuery('#contact_mo').val('');
		jQuery('#contact_fx').val('');
		jQuery('#contact_em').val('');
	}
	
	function copy_contact()
	{
		jQuery('#cp1').val($j('#fss1').val());
		jQuery('#cp2').val($j('#fss2').val());
		jQuery('#cp3').val($j('#fss3').val());
		jQuery('#contact_title').val($j('#fss_title').val());
		jQuery('#contact_on').val($j('#fss_on').val());
		jQuery('#contact_hf').val($j('#fss_hf').val());
		jQuery('#contact_mo').val($j('#fss_mo').val());
		jQuery('#contact_fx').val($j('#fss_fx').val());
		jQuery('#contact_em').val($j('#fss_em').val());
	}
</script>
<div id="paga_content_outside">
    <div id="pagecontent" style="float:none;">
        <div id="left-container">
        	<div id="form_wrapper" style="font-family:'karla'; width:630px!important;">
                ...
                <div style="line-height:15px;">
                    ...
                    In 2014, the big day falls on Sunday, 09th of February. With a usual crowd of approximately 300,000 we expect that we will have many hungry mouths to feed!<br/><br/>
                    <span class="subheading2_content_page">APPLICATION INSTRUCTIONS</span><br/><br/>
                    For public health and safety reasons, the Port Phillip City Council manages various special events through its Local Law No. 1 (Community Amenity). A permit is needed to trade at the St Kilda Festival and to use Council parks and reserves, including the foreshore and roads for a range of activities. <br/><br/>
                    <span class="subheading2_content_page">APPLICATION STATUS NOTIFICATION </span><br/><br/>
                    Whilst we encourage and welcome applications from stallholders, spaces are limited. Completing this application process does not guarantee you a site. Notification on the status of your application will be provided in late December. Your site will be confirmed once payment of the issued tax invoice has been received. St Kilda Festival Management reserves the right to cancel your application at any time and without notice. Failure to pay the issued invoice within the terms of payment may result in a cancellation of your application.<br/><br/>
                    Trader selection and placement is at the absolute discretion of St Kilda Festival Management. <br/><br/>
                    The closing date for all applications is <span style="font-weight:bold">FRIDAY, 29 NOVEMBER, 2013. Late applications may not be accepted</span>.<br/><br/>
                    Several pieces of supporting documentation are required to complete your application, including pictures of your stall, and a checklist is provided within this application for your convenience. All supporting documentation must be received by <span>WEDNESDAY, 03 DECEMBER, 2013</span>, to ensure your application can be processed and considered. <br/><br/>
                    ...
                    Angela de Mel<br/>
Festival Trader Liaison & Accreditation Manager<br/>
St Kilda Festival 2014<br/>
T: 03 9209 6266<br/>
M: 0434 316 784<br/>
E: <a href="mailto:skftraders@portphillip.vic.gov.au">skftraders@portphillip.vic.gov.au</a><br/><br/>
                </div>
                
                <form name="foodForm" id="foodForm" method="post" enctype="multipart/form-data" action="<?=base_url()?>page/form_food_process_test">
				...
				?>
                    ...
                    <div class="gap"></div>
                        ...
                        <div style="float:left"><input type="file" onchange="check_image();" class="textfield validate['required']" name="stall_photo" style="width:200px" /></div>
                    </div>
                    ...
                    <div>
                        ...
                        <div style="float:left">
                        	<select class="form_input" name="power_option">
                                <option value="1 x 15 amp outlet - $113.00">1 x 15 amp outlet - $113.00</option>
                                <option value="2 x 15 amp outlet - $226.00">2 x 15 amp outlet - $226.00</option>
                                <option value="3 x 15 amp outlet - $339.00">3 x 15 amp outlet - $339.00</option>
                                <option value="1 x 3 phase outlet (32 amp, 5 pin, 3 phase) - $430.00" />1 x 3 phase outlet (32 amp, 5 pin, 3 phase) - $430.00</option>
                    ...
                    <div class="gap"></div>
                    <div style="line-height:15px;">
                        Storage capacity for cool rooms is extremely limited. Cool room sites are subject to availability and charged at a flat rate of $113.00 per cool room site. Sites allocated are at the discretion of St Kilda Festival Management.
                    </div>
                    ...
                    <div>
                        ...
                        <div style="float:left">3x3m Marquee Package - $267.00 includes 3x3 Marquee, 2 chairs, 1 x 8' trestle table</div>    
                    </div>
                    <div class="gap"></div>
                    <div>
                        <div class="form_label" style="float:left; width:50px;">
                        ...
                        <div style="float:left">6x3m Marquee Package - $504.00 includes 6x3 Marquee, 2 chairs, 2 x 8' trestle table</div>    
                    </div>
                    <div class="gap"></div>
                    <div>
                        <div class="form_label" style="float:left; width:50px;">
                    ...
                    <div>
                        <div class="form_label" style="float:left; width:50px;">
                        	<input type="radio" class="validate['required']" id="hr1" name="health_registration" value="Option 1:Class 2 & 3 Traders: I have lodged a Statement of Trade form electronically on Streatrader." />
                        </div>
                        <div style="float:left; width:550px;">Option 1:Class 2 & 3 Traders: I have lodged a Statement of Trade form electronically on Streatrader.</div>    
                    </div>
                    <div class="gap"></div>
                    ...
                    <div>
                        <div class="form_label" style="float:left; width:50px;">
                        	<input type="radio" class="validate['required']" id="hr2" name="health_registration" value="Option 2:Class 4 Traders: I have lodged a Notification form electronically on Streatrader." />
                        </div>
                        <div style="float:left; width:550px">Option 2:Class 4 Traders: I have lodged a Notification form electronically on Streatrader.</div>    
                    </div>
                    <div class="gap"></div>
                    ...
                    <div style="line-height:15px;">
                         <div class="form_label" style="float:left; width:50px;">
                        	<input type="radio" class="validate['required']" id="nt1" name="new_trader" value="(All Traders):   I have registered a Temporary or Mobile Food Premises electronically on Streatrader." />
                        </div>
                        <div style="float:left; width:550px">(All Traders):   I have registered a Temporary or Mobile Food Premises electronically on Streatrader.</div>    
                    </div>
                    <div class="gap"></div>
                    ...
                    <div style="line-height:15px;">
                       <input type="radio" name="health_registration" id="hr2" class="validate['required']" value="I have submitted my Food Act documents via the Victorian Government Streatrader website" />&nbsp;I have submitted my Food Act documents via the Victorian Government 'Streatrader' website
                    </div>
                    ...
                    <div class="gap"></div>
                    <div style="line-height:15px;">
                        Further information for Temporary and Mobile Food Premises can be downloaded <a href="<?=base_url()?>uploads/Doc_39.pdf" target="_blank">here</a>
                    </div>
                    <div class="gap"></div>
                    ...
                    <div>
                        ...
                        <div style="float:left">I will not require vehicle access to the Festival Precinct during Bump In and Bump Out on Festival Sunday.</div>
                    </div>
                    <div class="gap"></div>
                    ...
                    <div>
                        ...
                        <div style="float:left">I require vehicle access to the Festival Precinct during the permitted times on Festival Sunday :</div>
                    </div>
                    <div class="gap"></div>
                    <div style="line-height:15px;">
                    ...
                    <div style="float:none;">
                        <div class="form_label" style="float:left; width:50px">
                        	<input type="radio" id="veh_1_require" name="veh_1_require" value="I will require Festival allocated parking for this vehicle (not required for actual food vans, only support vehicles requiring car parking facilities)" />
                        </div>
                        <div style="float:left"><p>I will require Festival allocated parking for this vehicle <br /> (not required for actual food vans, only support vehicles requiring car parking facilities)</p>
                        </div>
                    </div>
                    <div class="gap"></div>
                    <div style="line-height:15px;">
                    ...
                    <div style="float:none;">
                        <div class="form_label" style="float:left; width:50px">
                        	<input type="radio" id="veh_2_require" name="veh_2_require" value="I will require Festival allocated parking for this vehicle (not required for actual food vans, only support vehicles requiring car parking facilities)" />
                        </div>
                        <div style="float:left"><p>I will require Festival allocated parking for this vehicle <br />(not required for actual food vans, only support vehicles requiring car parking facilities)</p>
                        </div>
                    </div>
                    ...
                    <div style="float:none;">
                        <div class="form_label" style="float:left; width:50px">
                        	<input type="radio" id="veh_3_require" name="veh_3_require" value="I will require Festival allocated parking for this vehicle (not required for actual food vans, only support vehicles requiring car parking facilities)" />
                        </div>
                        <div style="float:left"><p>I will require Festival allocated parking for this vehicle <br />(not required for actual food vans, only support vehicles requiring car parking facilities)</p>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div style="width:auto; float:left">$28.00</div>
                    </div>
                    <div class="gap"></div>
                    <div>
                        ...
                        <div style="width:auto; float:left">$64.60 per square metre<br />$99.70 per square metre</div>
                    </div>
                    <div class="gap"></div>
                    <div>
                        <div style="width:400px; float:left">Cool room site permit fee (GST not applicable)</div>
                        <div style="width:auto; float:left">$113.00</div>
                    </div>
                    <div class="gap"></div>
                    <div>
                        ...
                        <div style="width:auto; float:left">$267.00<br />$504.00</div>
                    </div>
                    <div class="gap"></div>
                    <div>
                        ...
                        <div style="width:auto; float:left">$113.00 per outlet<br />$430.00 per outlet</div>
                    </div>
                    <div class="gap"></div>
                    <hr />
                    <div class="gap"></div>
                    ...
                    <div class="gap"></div>
                    <div style="line-height:15px;">
                        Total revenue/sales figures for trade on the day of the event must be detailed on the <a href="<?=base_url()?>uploads/Doc_40.pdf" target="_blank">Trader Revenue Declaration form</a> and submitted by close of business on Wednesday 12th February 2014. Please submit this information by fax or email as per details below.
                    </div>
                    <div class="gap"></div>
                    <div style="line-height:15px;">
                        Email: <a href="mailto:skftraders@portphillip.vic.gov.au">skftraders@portphillip.vic.gov.au</a>
                    </div>
                    <div class="gap"></div>
                    <div style="line-height:15px;">
                        Fax: 03 9536 2717
                    ...
                    - <a href="<?=base_url()?>uploads/Doc_34.pdf" target="_blank">General Information: Download Here</a> <br /><br/>
                    - <a href="<?=base_url()?>uploads/Doc_37.pdf" target="_blank">General Conditions: Download Here</a><br/><br/>
                    - <a href="<?=base_url()?>uploads/Doc_36.pdf" target="_blank">Food Trader Checklist: Download here</a><br/><br/>
                    ...
                    <div style="line-height:15px;">
                        ...
                        <ul>
                            ...
                            <li>- Food Act Statement of Trade Form</li>
                        </ul>
                        <br/>
                        Please ensure your application number is noted on all supporting documentation sent in to the St Kilda Festival.<br/><br/>
                        This information must be provided by <b>WEDNESDAY, 03rd DECEMBER 2013</b> or your application may not be considered. Your documentation can be forwarded by the following methods:<br/><br/>
                        By post:<br/>
                        Angela de Mel<br />
                        Festival Trader Liaison & Accreditation Manager<br />
                        St Kilda Festival 2014<br />
                    ...
                    <div style="line-height:15px;">
                        ...
                        The personal information requested on this form is being collected by the council for the St Kilda Festival permits process. The personal information will be used solely by the council for that primary purpose or directly related purposes.
                    </div>
                    <div class="gap"></div>
