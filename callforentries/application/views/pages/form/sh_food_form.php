        ...
        <div id="left-container">
        	<div id="form_wrapper" style="font-family:'karla'; width:630px!important;">
                ...
                <div style="line-height:15px;">
                    ...
                    In 2015, the big day falls on Sunday, 08th of February. With a usual crowd of up to 450,000, we expect that we will have many hungry mouths to feed!<br/><br/>
				...
				?>
                    ...
                    <div class="gap"></div>
                    <div style="line-height:15px;">
                        Storage capacity for cool rooms is extremely limited. Cool room sites are subject to availability and charged at a flat rate of $116.40 per cool room site. Sites allocated are at the discretion of St Kilda Festival Management.
                    </div>
                    ...
                    <div>
                        <div class="form_label" style="float:left; width:50px;">
                        	<input type="radio" class="validate['required']" name="hire_package" value="3x3m Marquee Package - $275.00 (Includes 3x3 Marquee, 2 chairs, 1 x 8' trestle table)" />
                        </div>
                    ...
                    <div>
                        <div class="form_label" style="float:left; width:50px;">
                        	<input type="radio" class="validate['required']" name="hire_package" value="6x3m Marquee Package - $519.10 (Includes 6x3 Marquee, 2 chairs, 2 x 8' trestle table)" />
                        </div>
                    ...
                    <div class="gap"></div>
                    <div style="line-height:15px;">
                        Further information for Temporary and Mobile Food Premises can be downloaded <a href="<?=base_url()?>uploads/Doc_309_Itinerant_FOOD_Traders_2015.pdf" target="_blank">here</a>
                    </div>
                    <div class="gap"></div>
                    ...
                    <div>
                        ...
                        <div style="width:50px; float:left; text-align:right">$28.80</div>
                    ...
                    <div>
                        ...
                        <div style="width:50px; float:left; text-align:right">$71.06<br />$109.67</div>
                        <div style="width:30px; float:left;">&nbsp;</div>
                        <div style="width:auto; float:left">per square metre<br />per square metre</div>
                    </div>
                    <div class="gap"></div>
                    <div>
                        <div style="width:400px; float:left">Cool room site permit fee (GST not applicable)</div>
                        <div style="width:50px; float:left; text-align:right">$116.40</div>
                    </div>
                    <div class="gap"></div>
                    <div>
                        ...
                        <div style="width:50px; float:left; text-align:right">$275.00<br /><br />$519.10</div>
                    </div>
                    <div class="gap"></div>
                    <div>
                        ...
                        <div style="width:50px; float:left; text-align:right">$116.40<br />$442.90</div>
                        <div style="width:30px; float:left;">&nbsp;</div>
                        <div style="width:auto; float:left">per outlet<br />per outlet</div>
                    </div>
                    <div class="gap"></div>
                    <hr />
                    <!--<div class="gap"></div>
                    ...
                    - <a href="<?=base_url()?>uploads/Doc_305_Itinerant_FOOD_Traders_2015.pdf" target="_blank">Important Information: Download Here</a> <br /><br/>
                    - <a href="<?=base_url()?>uploads/Doc_306_Itinerant_FOOD_Traders_2015.pdf" target="_blank">General Conditions: Download Here</a><br/><br/>
                    - <a href="<?=base_url()?>uploads/Doc_300_Itinerant_FOOD_Traders_2015.pdf" target="_blank">Food Trader Checklist: Download here</a><br/><br/>
                    ...
                    <div style="line-height:15px;">
                        ...
                        This information must be provided by <b>WEDNESDAY, 03rd DECEMBER 2014</b> or your application may not be considered. Your documentation can be forwarded by the following methods:<br/><br/>
                        By post:<br/>
                        Angela de Mel<br />
                        Festival Trader Liaison & Vending Manager<br />
                        St Kilda Festival 2015<br />
