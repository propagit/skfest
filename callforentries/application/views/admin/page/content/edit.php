...
<div id="left-content">
    ...
    <div class="box-add">
        ...
        <tr>
        	<td> <input type="text" style="width:300px; height:25px;color:#B9B2AE;font-weight:bold; font-size:15px;padding:3px;" name="title" id="title" value="<?=$pages['title']?>" /> </td>
        </tr>
        <tr><td>&nbsp;</td></tr>
        <tr>
        <td>Content</td>
        ...
        <option value="0">Please select</option>
            ...
            foreach($galleries as $gallery){
                ?>
                <option value=<?=$gallery['id']?> <? if($pages['gallery']==$gallery['id']){echo "Selected=selected;";}?>><?=$gallery['title']?></option>
                <?
            }
            ?>
        </select>
